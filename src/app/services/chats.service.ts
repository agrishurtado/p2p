...
export class ChatsService {
  ...
  addChatMessage(msg, de){
    ...
    return this.afs.collection('chatpublico').add({
      msg,
  ...
  getChatMessages(){
    ...
    return this.getUsers().pipe(
      switchMap(rest => {
        ...
        return this.afs.collection('chatpublico', ref => ref.orderBy('createdAt')).valueChanges({ idField: 'id'}) as Observable<Message[]>
      }),
      map(messages => {
